//Union type
export type ErrorType = 'NOT_FOUND' | 'CONFLICT' | 'BAD_REQUEST' | 'INTERNAL_SERVER_ERROR' | 'UNAUTHORIZED' | 'FORBIDDEN';

export class Exception extends Error {
  #error: ErrorType;
  #statusCode: number;

  constructor({ error, statusCode, message }: { error: ErrorType, statusCode: number, message: string }) {
...
export class InternalServerException extends Exception {
  constructor() {
    super({ error: 'INTERNAL_SERVER_ERROR', statusCode: 500, message: "" });
  }
}
